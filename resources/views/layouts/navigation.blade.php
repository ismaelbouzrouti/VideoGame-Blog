        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('faq.faqPage')" :active="request()->routeIs('faq.faqPage')">
                        {{ __('FAQ') }}
                    </x-nav-link>
                    @if(auth()->check() && auth()->user()->isAdmin == 1)
                    <x-nav-link :href="route('contact.contactAdminPage')"
                        :active="request()->routeIs('contact.contactAdminPage')">
                        {{ __('Contact') }}
                    </x-nav-link>

                    @else
                    <x-nav-link :href="route('contact.contactPage')"
                        :active="request()->routeIs('contact.contactPage')">
                        {{ __('Contact') }}
                    </x-nav-link>
                    @endif
                </div>
